...
clf = Pipeline([("vectorizer",
                ...
                ("classifier", OneVsRestClassifier(KNeighborsClassifier(n_neighbors=3), n_jobs = 4))])
...
# evaluate classsifier using 10 fold cross validation method on F1 score
...
print("EconBiz average F-1 score:", evaluate('sample-econ.csv'))